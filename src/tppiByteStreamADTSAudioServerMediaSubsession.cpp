...
tppiByteStreamADTSAudioServerMediaSubsession*
tppiByteStreamADTSAudioServerMediaSubsession::createNew(UsageEnvironment& env, tppiByteStreamAACParameters params, Boolean reuseFirstSource) {
  return new tppiByteStreamADTSAudioServerMediaSubsession(env, params, reuseFirstSource);
}
...
FramedSource* tppiByteStreamADTSAudioServerMediaSubsession
::createNewStreamSource(unsigned /*clientSessionId*/, unsigned& estBitrate) {
  ...
  tppiByteStreamAACSource *tppiAudioSource = tppiByteStreamAACSource::createNew(envir(), fParams);
...
RTPSink* tppiByteStreamADTSAudioServerMediaSubsession
