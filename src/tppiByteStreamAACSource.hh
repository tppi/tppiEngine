...
#ifndef _TPPI_BYTE_STREAM_AAC_SOURCE_HH
#define _TPPI_BYTE_STREAM_AAC_SOURCE_HH
...
class tppiByteStreamAACParameters {
  //%%% TO BE WRITTEN %%%
public:
...
class tppiByteStreamAACSource: public FramedSource {
public:
  static tppiByteStreamAACSource* createNew(UsageEnvironment& env,
...
protected:
  tppiByteStreamAACSource(UsageEnvironment& env,
		       tppiByteStreamAACParameters params,
		       unsigned preferredFrameSize,
		       unsigned playTimePerFrame);
	// called only by createNew()

  virtual ~tppiByteStreamAACSource();
