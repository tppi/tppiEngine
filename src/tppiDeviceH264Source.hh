...
#ifndef _TPPIDEVICE_H264_SOURCE_HH
#define _TPPIDEVICE_H264_SOURCE_HH
...
class tppiDeviceH264Parameters {
  //%%% TO BE WRITTEN %%%
public:
...
class tppiDeviceH264Source: public FramedSource {
public:
  static tppiDeviceH264Source* createNew(UsageEnvironment& env,
...
protected:
  tppiDeviceH264Source(UsageEnvironment& env, tppiDeviceH264Parameters params);
  // called only by createNew(), or by subclass constructors
  virtual ~tppiDeviceH264Source();
